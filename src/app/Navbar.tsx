      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/contact"
              className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-all duration-300 shadow-md hover:shadow-lg font-medium text-sm"
            >
              Contact
            </Link>
          </div>
