...
import "../globals.css";
import "./singlegrain-real.css";
import SGNavbar from "@/components/singlegrain-real/SGNavbar";
import SGFooter from "@/components/singlegrain-real/SGFooter";
...
export default function SingleGrainRealLayout({
  children,
}: {
