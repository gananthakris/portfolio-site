          ...
          {methodology.map((step, index) => (
            ...
            >
              <div className="flex-shrink-0">
                <div className="w-16 h-16 rounded-full bg-sg-primary flex items-center justify-center text-white text-2xl font-bold">
                  {step.step}
                </div>
              </div>
              <div className="flex-1 card">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                  ...
                  <span className="text-sm font-semibold text-sg-primary mt-2 md:mt-0">
                    {step.duration}
                  </span>
                </div>
